        ...
        <table className="w-full min-w-[900px] text-left text-sm">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50/80 text-xs text-text-muted">
              ...
              <th className="px-5 py-3 font-medium">Dosha | Status</th>
            ...
            {records.length === 0 ? (
              ...
              records.map((record) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-text-muted">{record.appointmentDate}</td>
                  <td className="px-5 py-4">
                  ...
                  <td className="px-5 py-4">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg bg-sidebar px-3 py-1.5 text-xs font-medium text-brown hover:bg-gold/10"
                    >
                      <Upload className="h-3.5 w-3.5 text-gold" strokeWidth={1.5} />
                      Upload
                    </button>
                  </td>
                </tr>
